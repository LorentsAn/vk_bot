...
const VALID_GET_ALL_TASK_COMMAND = "\𝗀𝖾𝗍_𝗍𝖺𝗌𝗄 [-a] | [-c]";
...
Перечень команд: \n "
    ...
    \t ^ Посмотреть задачи, которые ты себе ставил. Флаг -a - вывести все задачи. Флаг -c - вывести только не законченные. По умолчанию выводятся незаконченные. \n"
